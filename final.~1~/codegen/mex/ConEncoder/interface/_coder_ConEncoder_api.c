 ...
 *
 * Code generation for function '_coder_ConEncoder_api'
 *
 */
...
void ConEncoder_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                    *plhs[1])
{
  emxArray_real_T *out;
  real_T (*in)[10];
  ...
  ConEncoder(&st, *in, size, out);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(out);
  out->canFreeData = false;
  emxFree_real_T(&st, &out);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

/* End of code generation (_coder_ConEncoder_api.c) */
