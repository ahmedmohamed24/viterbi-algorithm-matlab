START_DIR = Z:\Documents\Viterbi Algorithm\final

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2018a
MAKEFILE = ConEncoder_mex.mk

include ConEncoder_mex.mki
...
SRC_FILES =  \
	...
	_coder_ConEncoder_api.c \
	_coder_ConEncoder_mex.c \
	ConEncoder_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = ConEncoder_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\ConEncoder"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ConEncoder/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
