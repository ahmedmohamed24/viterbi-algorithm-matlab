START_DIR = Z:\Documents\Viterbi Algorithm\final\codegen\ConEncoder\fixpt\fxptmp

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2018a
MAKEFILE = ConEncoder_wrapper_fixpt_hdl_mex_mex.mk

include ConEncoder_wrapper_fixpt_hdl_mex_mex.mki


SRC_FILES =  \
	ConEncoder_wrapper_fixpt_hdl_mex_data.c \
	...
	_coder_ConEncoder_wrapper_fixpt_hdl_mex_info.c \
...
MEX_FILE_NAME_WO_EXT = ConEncoder_wrapper_fixpt_hdl_mex
...
SYS_INCLUDE += -I"$(START_DIR)\ConEncoder_wrapper_fixpt"
...
%.$(OBJEXT) : $(START_DIR)\ConEncoder_wrapper_fixpt/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
