/*
 * ConEncoder_wrapper_fixpt_hdl_mex_initialize.c
 *
 * Code generation for function 'ConEncoder_wrapper_fixpt_hdl_mex_initialize'
 *
 */
...
static void c_ConEncoder_wrapper_fixpt_hdl_(const emlrtStack *sp);
...
static void c_ConEncoder_wrapper_fixpt_hdl_(const emlrtStack *sp)
{
  ...
  st.site = NULL;
  ConEncoder_fixpt_logger_init();
  st.site = NULL;
  in_TB_logger_init(&st);
  st.site = NULL;
  size_TB_logger_init(&st);
  st.site = NULL;
  ...
  char * n, real_T o, emlrtMCInfo *location)
{
  ...
  pArrays[12] = emlrtCreateString(n);
  pArrays[13] = emlrtCreateDoubleScalar(o);
  return emlrtCallMATLABR2012b(sp, 1, &m3, 14, pArrays, "numerictype", true,
    location);
}

void ConEncoder_wrapper_fixpt_hdl_mex_initialize(void)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    c_ConEncoder_wrapper_fixpt_hdl_(&st);
  }
}

/* End of code generation (ConEncoder_wrapper_fixpt_hdl_mex_initialize.c) */
